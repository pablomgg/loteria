...
namespace Loteria.Domain.Dtos.MegaSena;
...
public class MegaSena
{
    ...
    public static implicit operator Concurso(MegaSena dto)
    {
        var dezenas = dto.DezenasSorteadasOrdemSorteio ?? dto.ListaDezenas;
        
        var concurso = new Concurso
        {
            TipoJogo = TipoJogoLoteria.MegaSena,
